...
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, rcv_buf[1]);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, rcv_buf[0]);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, rcv_buf[1]);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, rcv_buf[0]);
...
//
	printf("Wheel_1: %f  Wheel_2: %f  Wheel_3: %f Wheel_4: %f BNO: %f   \n", w1,
			w2, w3, w4, curr_angle);
	__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1,(int)((w1>0) ? w1:(w1*-1)) );
	__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2,(int)((w2>0) ? w1:(w2*-1)) );
	__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3,(int)((w3>0) ? w1:(w3*-1)) );
	__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4,(int)((w4>0) ? w1:(w4*-1)) );
}
...
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, 0 );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, 0 );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, a );
//		}
//
//		if(a<0&&b>0){
//			__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, 0 );
//			__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, 0);
//			__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, a*(-1) );
//			__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, 0 );
//		}
//
//		if(a>0&&b<0){
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, 0 );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, b );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, 0);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, 0 );
//		}
//
//		if(a>0&&b>0){
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, (b)*(-1)  );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, 0 );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, 0 );
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, 0);
//
