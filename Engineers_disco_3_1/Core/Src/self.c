...
//
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_1, 10);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_2, 50);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_3, 100);
//		__HAL_TIM_SET_COMPARE(&htimer4, TIM_CHANNEL_4, 200);
		HAL_Delay(1);
